...
namespace Scrapers.Persistence.Migrations
{
    ...
    [Migration("20260718001546_AddNameClassificationLog")]
    partial class AddNameClassificationLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scrapers.Persistence.Entities.NameClassificationLogEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<double>("MlConfidence")
                        ...
                        .HasColumnName("ml_confidence");

                    b.Property<string>("MlDecision")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("ml_decision");
                    ...
                    b.Property<string>("NameFilterDecision")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("name_filter_decision");

                    b.Property<string>("NameFilterReason")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("name_filter_reason");
                    ...
                    b.Property<string>("UserClassification")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_classification");

                    b.HasKey("Id");

                    b.HasIndex("MlDecision");

                    b.HasIndex("NameFilterDecision");

                    b.HasIndex("ReviewedAt");

                    b.ToTable("name_classification_log", (string)null);
                });
