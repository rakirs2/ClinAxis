...
public sealed class NavBarTests
{
    ...
    public void NavigationHasSevenTabs()
    {
        ...
        Assert.AreEqual(7, cut.FindAll(".nav-link").Count);
    }
    ...
    public void NavigationTabLabelsAreCorrect()
    {
        ...
        Assert.AreEqual("Investigator Finder", cut.FindAll(".nav-link")[2].TextContent.Trim());
        Assert.AreEqual("Best-PI", cut.FindAll(".nav-link")[3].TextContent.Trim());
        Assert.AreEqual("Data Quality", cut.FindAll(".nav-link")[4].TextContent.Trim());
        Assert.AreEqual("Blog", cut.FindAll(".nav-link")[5].TextContent.Trim());
        Assert.AreEqual("Status", cut.FindAll(".nav-link")[6].TextContent.Trim());
    }
    ...
    public void NavigationTabHrefsAreCorrect()
    {
        ...
        Assert.AreEqual("/investigator-finder", cut.FindAll(".nav-link")[2].GetAttribute("href"));
        Assert.AreEqual("/recommend-investigators", cut.FindAll(".nav-link")[3].GetAttribute("href"));
